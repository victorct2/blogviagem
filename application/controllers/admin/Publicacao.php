...
class Publicacao extends CI_Controller {
   ...
   public function __construct(){
	...
	public function index($pular=null,$post_por_pagina=null)#váriaveis para a paginação
	{   
	      ...
	      $dados['link_paginacao'] = $this->pagination->create_links();
	 	  ...
	 	  $dados['publicacaoes'] = $this->modelpublicacao->listar_publicacao($pular,$post_por_pagina);
