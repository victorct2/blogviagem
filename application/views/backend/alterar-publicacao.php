                  ...
                  <div class="form-group">
                    ...
                    <option value="<?php echo $categoria->id?>" <?php if($categoria->id == $publicacao->categoria){echo "selected";}?>><?php echo $categoria->titulo ?></option>
                      ...
                      <?php }?>
                                ...
                                <input type="text" id="txt-titulo" name="txt-titulo" class="form-control" placeholder="Digite o Título" value="<?php echo $publicacao->titulo; ?>">
                                </div>
                                <div class="form-group">
                                <label id="txt-subtitulo">SubTítulo</label>
                                <input type="text" id="txt-subtitulo" name="txt-subtitulo" class="form-control" placeholder="Digite o Subtítulo" value="<?php echo $publicacao->subtitulo; ?>">
                                </div>
                                 ...
                                 <input type="datetime-local" id="txt-data" name="txt-data" class="form-control" placeholder="Digite a data" value="<?php echo strftime('%Y-%m-%dT%H:%M:%S', strtotime($publicacao->data)) ; ?>">
                                 </div>
